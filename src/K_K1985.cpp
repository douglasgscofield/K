...
/*///////////////////////////////////////////////////////////////////////*/
KConfig     initiate_K1985          (KInt MI, KInt MJ,
                                     KScalar U,
                                     KScalar d, KInt k, KScalar alpha)
{
    KConfig K;
...
void        set_fitness_K1985       (KConfig K, KScalar U,
                                     KScalar d, KInt k, KScalar alpha)
{
}

void        set_repro_K1985         (KConfig K, 
                                     KInt genot, KScalar y[], KScalar z[])
{
}

/*///////////////////////////////////////////////////////////////////////*/
void        compute_q_initial_K1985 (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        derive_q_K1985_from_x   (KConfig K, KArray2 qk, KArray x)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        derive_x_K1985_from_x   (KConfig K, KArray xk, KArray x)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        derive_qp_K1985         (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        derive_qpp_K1985        (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_F_female_K1985  (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_F_male_K1985    (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_beta_gamma_rho_gk_ak_hk_K1985   (KConfig K)
/*
    ...
    for (i=0; i <= K->MI; i++) {
        for (j=0; j <= K->MJ; j++) {
            ...
            for (g=0; g < K->genotypes; g++) {
                ...
                K->ak[g][i][j] = K->xp[g][i][j] * 
                                 (K->z[g] + K->y[g]*K->z[g]) / gammasum;
                K->hk[g][i][j] = K->xp[g][i][j] * 
                                 (1 - K->y[g]*K->z[g]) / rhosum;
            }
        }
    }
}
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_progeny_K1985  (KConfig K)
/*
                    ...
                    for (v=0; n <= K->MJ; v++) {
                            ...
                            for (lam=0; lam <= K->MJ; lam++) {
                                ...
                                for (xi=0; xi < K->genotypes; xi++) {
                                    for (zeta=0; zeta < K->genotypes; zeta++) {
                                        t2 = K->gk[xi][n][v] * K->hk[zeta][l][lam];
                                        ksum += t2 * O_transform(K, g, xi, zeta);
                                    }
                                }
                                leftsum += t1 * ksum;
                            }
                        ...
                        if (!K->mating_self && !K->mating_apomixis) {
                            ...
                            if (K->mating_apomixis) {
                                ...
                                nrerror("compute_progeny_K1985: unrecognized mating");
                            }
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_qpp_K1985       (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_Q_K1985         (KConfig K)
/*
...
/*///////////////////////////////////////////////////////////////////////*/
void        compute_q_nextgen_K1985 (KConfig K)
/*
