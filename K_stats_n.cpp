...
%lg\t%lg\t%lg\t\
%lg\t%lg\t%lg\t\
%lg\t%lg\t%lg\t%lg\t%lg\t%lg\n", (KN->generation > GENERATION_CUTOFF) ? "*" : " ", KN->generation, KN->S, KN->A, KN->O,
		   /* */
		   KN->U[0], get_fitness_function_name(KN->fitness_function[0]),
		   KN->fit_s[0], KN->fit_h[0],
		   /* */
		   KN->U[1], get_fitness_function_name(KN->fitness_function[1]),
		   KN->fit_s[1], KN->fit_h[1],
		   /* */
		   KStats_n.mean_hetloci[0], KStats_n.var_hetloci[0],
		   KStats_n.mean_homloci[0], KStats_n.var_homloci[0],
		   KStats_n.mean_totmuts[0], KStats_n.var_totmuts[0],
		   KStats_n.var_to_mean_totmuts_ratio[0],
		   /* */
		   KStats_n.mean_hetloci[1], KStats_n.var_hetloci[1],
		   KStats_n.mean_homloci[1], KStats_n.var_homloci[1],
		   KStats_n.mean_totmuts[1], KStats_n.var_totmuts[1],
		   ...
		   KStats_n.population_mean_fitness, KStats_n.inbreeding_depression,
		   KStats_n.secondary_selfing_rate);
}

/* ///////////////////////////////////////////////////////////// */
void
stats_print_table_heading_n(
	KConfig_n KN)
/*
...
*/
{
	...
	for (m = 0; m < KN->mutclasses; m++) {
		printf("mean_hetloci[%d] = %lg\n", m, KStats_n.mean_hetloci[m]);
		printf("var_hetloci[%d] = %lg\n", m, KStats_n.var_hetloci[m]);
		printf("mean_homloci[%d] = %lg\n", m, KStats_n.mean_homloci[m]);
		printf("var_homloci[%d] = %lg\n", m, KStats_n.var_homloci[m]);
		printf("mean_totmuts[%d] = %lg\n", m, KStats_n.mean_totmuts[m]);
		printf("var_totmuts[%d] = %lg\n", m, KStats_n.var_totmuts[m]);
	...
	KConfig_n KN)
{
	...
	for (m = 0; m < KN->mutclasses; m++) {
		...
		if (KStats_n.mean_totmuts[m] == 0.0) {
			...
			KStats_n.var_to_mean_totmuts_ratio[m] =
				KStats_n.var_totmuts[m] / KStats_n.mean_totmuts[m];
		}
	}
	KStats_n.mean_fitness_self_progeny = stats_mean_fitness_self_progeny_n(KN);
	KStats_n.mean_fitness_apomixis_progeny =
		stats_mean_fitness_apomixis_progeny_n(KN);
	KStats_n.mean_fitness_outcross_progeny =
		stats_mean_fitness_outcross_progeny_n(KN);
	KStats_n.population_mean_fitness = stats_population_mean_fitness_n(KN);
	KStats_n.inbreeding_depression = stats_inbreeding_depression_old_n(KN);
	KStats_n.secondary_selfing_rate = stats_secondary_selfing_rate_n(KN);
}

/* ///////////////////////////////////////////////////////////// */
KScalar
stats_mean_fitness_self_progeny_n(
	KConfig_n KN)
/*
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_mean_fitness_apomixis_progeny_n(
	KConfig_n KN)
/*
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_mean_fitness_outcross_progeny_n(
	KConfig_n KN)
/*
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_inbreeding_depression_old_n(
	KConfig_n KN)
/*
** Compute inbreeding depression (1 - self/outcross) from
** the load class data for selfed and outcrossed progeny.
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_secondary_selfing_rate_n(
	KConfig_n KN)
/*
...
*/
{
	...
	if (KStats_n.population_mean_fitness == 0.0) {
		...
		ans =
			KN->S * (KStats_n.mean_fitness_self_progeny /
					 KStats_n.population_mean_fitness);
	}
	return ans;
}
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_population_mean_fitness_n(
	KConfig_n KN)
/*
