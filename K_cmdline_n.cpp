...
", KN->U[0], KN->U[1], KN->fit_s[0], KN->fit_s[1], KN->fit_h[0], KN->fit_h[1], KN->S, KN->A, KN->option_truncate, KN->option_nolethal, KN->load_savefile, KN->load_savefile_name, KN->save_savefile, KN->save_savefile_name);
}
