...
%lg\t%lg\t\
%lg\t%lg\t%lg\t\
%lg\t%lg\t%lg\t%lg\t%lg\t%lg\n", (K->generation > GENERATION_CUTOFF) ? "*" : " ", K->generation, K->U, K->S[0], K->A[0], K->O[0], get_fitness_function_name(K->fitness_function), K->fit_s, K->fit_h, KStats.mean_hetloci, KStats.var_hetloci, KStats.mean_homloci, KStats.var_homloci, KStats.mean_totmuts, KStats.var_totmuts, KStats.var_to_mean_totmuts_ratio, KStats.mean_fitness_self_progeny, KStats.mean_fitness_apomixis_progeny, KStats.mean_fitness_outcross_progeny, KStats.population_mean_fitness, KStats.inbreeding_depression, KStats.secondary_selfing_rate);
}

/* ///////////////////////////////////////////////////////////// */
void
stats_print_table_heading(
	KConfig K)
/*
...
*/
{
	...
	KStats.mean_fitness_self_progeny = stats_mean_fitness_self_progeny(K);
	KStats.mean_fitness_apomixis_progeny =
		stats_mean_fitness_apomixis_progeny(K);
	KStats.mean_fitness_outcross_progeny =
		stats_mean_fitness_outcross_progeny(K);
	KStats.population_mean_fitness = stats_population_mean_fitness(K);
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_mean_fitness_self_progeny(
	KConfig K)
/*
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_mean_fitness_apomixis_progeny(
	KConfig K)
/*
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_mean_fitness_outcross_progeny(
	KConfig K)
/*
...
/* ///////////////////////////////////////////////////////////// */
KScalar
stats_inbreeding_depression_old(
	KConfig K)
/*
** Compute inbreeding depression (1 - self/outcross) from
** the load class date for selfed and outcrossed progeny.
...
*/
{
	...
	if (KStats.population_mean_fitness == 0.0) {
		...
		ans =
			K->S[g] * (KStats.mean_fitness_self_progeny /
					   KStats.population_mean_fitness);
	}
	return ans;
}
