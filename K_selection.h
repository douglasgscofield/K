...
KScalar fitness(
	...
	KInt j,
	KInt g);
KScalar mean_fitness(
	KConfig K,
	KArray & a);
KScalar mean_fitness_allprogeny(
	KConfig K,
	KArray & a);
KScalar cumulative_fitness(
	KConfig K,
	KArray & a);
void initiate_fitness_precomputed(
	KConfig K);

KInt register_fitness_function(
	KPtr_ff pff,
	char *ff_name);
void must_compute_fitness_function(
	KInt ff);
KPtr_ff get_fitness_function(
	KInt fm);
char *get_fitness_function_name(
	KInt ff);
...
KScalar fitness_multiplicative(
	KConfig K,
	KInt i,
	KInt j,
	KInt g);
KScalar fitness_kondrashov(
	KConfig K,
	KInt i,
	KInt j,
	KInt g);
