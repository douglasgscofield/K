		...
		for (j0 = 0; j0 <= KN->MJ0; j0++) {
			for (i1 = 0; i1 <= KN->MI1; i1++) {
				for (j1 = 0; j1 <= KN->MJ1; j1++) {
					...
					to[i0][j0][i1][j1] +=
						a_apomixis_n(i0, j0, i1, j1, n0, v0, n1,
									 v1) * KN->A * from[n0][v0][n1][v1];
				}
			}
		}
	}
...
*/
{
	...
	if (i0 > n0 || j0 < v0 || j0 > n0 + v0 || i0 + j0 > n0 + v0 || i1 > n1 ||
		j1 < v1 || j1 > n1 + v1 || i1 + j1 > n1 + v1)
		return 0.0;
